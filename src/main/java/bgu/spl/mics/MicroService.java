...
//    protected abstract MessageBus getMessageBus();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        this.msgBus.subscribeEvent(type,this);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        this.msgBus.subscribeBroadcast(type,this);
        callBacks.put(type,callback);
    }
    ...
    protected final <T> void complete(Event<T> e, T result) {
        this.msgBus.complete(e,result);
    }

    public  <T, E extends Event<T>> void setCallBacks(Class<E> type, Callback<E> callback) {
        this.msgBus.subscribeEvent(type, this);
        callBacks.put(type,callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            try{
                Message message=this.msgBus.awaitMessage(this);
